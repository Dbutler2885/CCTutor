...
var DataState;
(function (DataState) {
    DataState[DataState["FirstQuestionNoTerminal"] = 0] = "FirstQuestionNoTerminal";
    DataState[DataState["FirstQuestionTerminal"] = 1] = "FirstQuestionTerminal";
    DataState[DataState["OtherQuestionNoTerminal"] = 2] = "OtherQuestionNoTerminal";
    DataState[DataState["OtherQuestionTerminal"] = 3] = "OtherQuestionTerminal";
    DataState[DataState["SpecialCase"] = 4] = "SpecialCase";
    DataState[DataState["Intro"] = 5] = "Intro";
    DataState[DataState["ReviewOnly"] = 6] = "ReviewOnly";
    DataState[DataState["ReviewWithSnippet"] = 7] = "ReviewWithSnippet";
})(DataState || (DataState = {}));
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    if (message.type === "UPDATED_DATA_PACKAGE") {
        ...
        // Add the pulsing effect when a new DataPackage is available
